...
def build_parser() -> argparse.ArgumentParser:
    ...
    index_parser.add_argument("--embedding-backend", choices=["gemini", "openai", "hashing"], default=None)
    ...
    ask_parser.add_argument("--embedding-backend", choices=["gemini", "openai", "hashing"], default=None)
    ask_parser.add_argument("--embedding-model", default=None)
    ask_parser.add_argument("--generation-backend", choices=["gemini", "openai", "extractive"], default=None)
    ...
    evaluate_parser.add_argument("--embedding-backend", choices=["gemini", "openai", "hashing"], default=None)
    evaluate_parser.add_argument("--embedding-model", default=None)
    evaluate_parser.add_argument("--generation-backend", choices=["gemini", "openai", "extractive"], default=None)
