...
A source-grounded Retrieval Augmented Generation (RAG) system that indexes local documents, retrieves relevant chunks with FAISS, and answers questions with citations using OpenAI models or an offline extractive fallback.
...
If you want OpenAI-backed embeddings or generation, add your key to `.env`:
...
- [`app/embeddings.py`](./app/embeddings.py): OpenAI and offline embedding backends
